const BLOG = {
  ...
  seo: {
    keywords: ['Notionic', 'NCC-17039', 'Blog'],
    googleSiteVerification: '' // Remove the value or replace it with your own google site verification code
  },
  notionPageId: process.env.NOTION_PAGE_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionSpacesId: process.env.NOTION_SPACES_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionAccessToken: process.env.NOTION_ACCESS_TOKEN, // Useful if you prefer not to make your database public
  notionDomain: 'bashirs.notion.site',
  telegramToken: process.env.TELEGRAM_TOKEN, // The token of your Telegram bot
  telegramChatId: '5955776333', // The chat id of your Telegram bot
  ...
  comment: {
    ...
    supaCommentsConfig: {
      supabaseUrl: 'https://wwpxyhkxnfsfypmhmdhl.supabase.co', // The url of your Supabase instance
      supabaseAnonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Ind3cHh5aGt4bmZzZnlwbWhtZGhsIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTc2MTk5ODYsImV4cCI6MjAxMzE5NTk4Nn0.mg8cVNbJBLjAGLfcrxLlt01asQ_Rs1kHRY8VTSFv8L4' // The anonymous key of your Supabase instance
    },
    utterancesConfig: {
      repo: ''
    }
